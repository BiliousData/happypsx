	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "HAPPY TREE FRIENDS", {"TRIGGERED", "SLAUGHTER", NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, 0xFF9271FD, "TRIGGERED"},
				{StageId_1_2, 0xFF9271FD, "SLAUGHTER"},
			};
